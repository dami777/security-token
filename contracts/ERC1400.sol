...
contract ERC1400 {
    ...
    mapping(address => bool) public isOperator;                              // map to approve or revoke  operators
    mapping(address => bool) public isOperatorByPartition;                  // map to approve or revoke operators by partition
