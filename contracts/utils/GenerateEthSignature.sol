...
contract GenerateEthSignature {
    ...
    function generateEthSignature(Certificate.DomainData memory _domainData, Certificate.Holder memory _from, Certificate.Holder memory _to, uint256 _amount) external view returns (bytes32) {
